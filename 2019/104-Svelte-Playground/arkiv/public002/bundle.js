...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$1, 37, 0, 493);
    			attr_dev(h21, "class", "svelte-8ggeob");
    			add_location(h21, file$1, 38, 0, 512);
    			attr_dev(div, "class", "svelte-8ggeob");
    			add_location(div, file$1, 44, 0, 886);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const newGame = () => {
    		$$invalidate('a', a = random_1(1,20));
    		$$invalidate('b', b = random_1(1,20));
    		$$invalidate('hist', hist = []);
    	};
