...
TypPage = function (_Page) {
  _inherits(TypPage, _Page);
  ...
  function TypPage(x, y, w, h) {
    ...
    var _this = _possibleConstructorReturn(this, (TypPage.__proto__ || Object.getPrototypeOf(TypPage)).call(this, x, y, w, h, cols));
    ...
    _this.addButton(new TypButton('R', 'Riksdag', _this.x, _this.yoff[0], _this.w - 0, 3 * h - 3, function () {
      pages.partier.select('R', dbTree.R);
      return this.page.selected = this;
    }));
    _this.addButton(new TypButton('L', dbName.L, _this.x, _this.yoff[1], _this.w - 0, 3 * h - 3, function () {
      pages.partier.select('L', dbTree.L);
      return this.page.selected = this;
    }));
    _this.addButton(new TypButton('K', dbName.K, _this.x, _this.yoff[2], _this.w - 0, 3 * h - 3, function () {
  ...
  _createClass(TypPage, [{
            ...
            results1.push(function (typ, i) {
              if (i > 0) {
                _this2.addsButton(new Button('byt', x1, y1, dw, dh, function () {
                  return _this2.clickSwap(typ, i);
                }));
              }
              return _this2.addsButton(new Button(' x ', x2, y2, dw, dh, function () {
                return _this2.clickDelete(typ, i);
              }));
            }(typ, i));
          }
          return results1;
    ...
    value: function showSelectedPersons() {
      var button, h, i, j, k, knr, l, len, len1, len2, m, namn, pair, parti, partikod, ref, ref1, ref2, results, typ, y, y0;
      push();
      textAlign(LEFT, CENTER);
...
//# sourceMappingURL=TypPage.js.map
