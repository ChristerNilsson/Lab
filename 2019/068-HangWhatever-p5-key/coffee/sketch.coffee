...
drawLetters = (letters,x,r,g,b) ->	
	for letter,i in letters
		fc r,g,b
		text letter,x,SIZE*(i+1.5)

draw = ->
	bg 0
	drawLetters hm.green,100,0,1,0
	drawLetters hm.red,200,1,0,0

keyPressed = ->	
	if key in hm.green or key in hm.red then return  
	for ltr,i in hm.secret 
		if ltr == key then hm.green[i] = key
	if key not in hm.green then hm.red.push key
