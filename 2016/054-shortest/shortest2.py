...
class Solver:
    ...
    def step(self):
        ...
        self.q = self.q2
        print len(self.q),len(self.tree)
        return self.q
...
#print solve(300,200) #== [300, 150, 152, 76, 38, 19, 21, 23, 25, 50, 100, 200]
#print solve(2000,3000) #== [3000, 1500, 750, 752, 376, 188, 94, 96, 48, 50, 25, 27, 29, 31, 62, 124, 248, 250, 500, 1000, 2000]
print len(solve(30000000,20000000))# == [30000, 15000, 7500, 3750, 3752, 1876, 938, 940, 470, 472, 236, 118, 120, 60, 62, 31, 33, 35, 37, 39, 78, 156, 312, 624, 1248, 1250, 2500, 5000, 10000, 20000]
...
# assert solve(20000000,30000000) == [20000000, 10000000, 5000000, 2500000, 1250000, 625000, 312500, 156250, 156252, 78126, 78128, 39064, 19532, 9766, 9768, 4884, 2442, 2444, 1222, 1224, 612, 306, 308, 154, 156, 78, 80, 40, 20, 22, 24, 26, 28, 56, 112, 114, 228, 456, 912, 914, 1828, 1830, 3660, 3662, 7324, 14648, 29296, 58592, 117184, 117186, 234372, 234374, 468748, 468750, 937500, 1875000, 3750000, 7500000, 15000000, 30000000]
