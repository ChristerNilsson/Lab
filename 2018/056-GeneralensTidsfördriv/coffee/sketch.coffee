...
oneClick = (data,marked,board,sharp=false) ->
	if data.lastMarked == marked then data.counter++ else data.counter = 0
...
assert 11, oneClick {lastMarked:0, counter:0},4,b1 # hj5 to hj4
assert 5,  oneClick {lastMarked:0, counter:0},5,b1 # kl3 no move
assert 8,  oneClick {lastMarked:0, counter:0},6,b1 # sp5 to hole

assert 10, oneClick {lastMarked:0, counter:0},7,b1 # ru5 to ru4
assert 8,  oneClick {lastMarked:7, counter:0},7,b1 # ru5 to hole

assert 8, oneClick {lastMarked:0, counter:0},8,b1 # hole click
assert 9, oneClick {lastMarked:0, counter:0},9,b1 # sp3 no move

assert 7, oneClick {lastMarked:0, counter:0},10,b1 # ru4 to ru5
assert 8, oneClick {lastMarked:10, counter:0},10,b1 # ru4 to hole
assert 7, oneClick {lastMarked:10, counter:1},10,b1 # ru4 to ru5

assert 4, oneClick {lastMarked:0, counter:0},11,b1 # hj4 to hj5
assert 8, oneClick {lastMarked:11, counter:0},11,b1 # hj4 to hole

assert 1, oneClick {lastMarked:0, counter:0},12,b1 # hj2 to A
assert 8, oneClick {lastMarked:0, counter:0},13,b1 # kl5 to hole

assert 5, oneClick {lastMarked:0, counter:0},14,b1 # kl4 to kl3
assert 8, oneClick {lastMarked:14, counter:0},14,b1 # kl4 to hole

assert 11, oneClick {lastMarked:0, counter:0},15,b1 # hj3 to hj4
assert 8, oneClick {lastMarked:15, counter:0},15,b1 # hj3 to hole

assert 8, oneClick {lastMarked:0, counter:0},16,b1 # kl6 to hole

assert 6, oneClick {lastMarked:0, counter:0},17,b1 # sp4 to sp5
assert 9, oneClick {lastMarked:17, counter:0},17,b1 # sp4 to sp3
assert 8, oneClick {lastMarked:17, counter:1},17,b1 # sp4 to hole

assert 2, oneClick {lastMarked:0, counter:0},18,b1 # sp2 to A

assert 7, oneClick {lastMarked:0, counter:0},19,b1 # ru6 to ru5
assert 8, oneClick {lastMarked:19, counter:0},19,b1 # ru6 to hole
