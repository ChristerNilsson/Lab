...
var Button, Enemy, Market, Node, Person, Place, Shortcut, buttons, display, messages, mousePressed, nodes, p, page, person, randint, setup;
...
Shortcut = function (_Node2) {
  _inherits(Shortcut, _Node2);
  ...
  _createClass(Shortcut, [{
    ...
    value: function execute(command) {
      ...
      if (command === 'New') {
        ...
        _get(Shortcut.prototype.__proto__ || Object.getPrototypeOf(Shortcut.prototype), "execute", this).call(this, command);
        show = false;
      }
      if (show) {
        return this.show();
...
Place = function (_Node3) {
  _inherits(Place, _Node3);
