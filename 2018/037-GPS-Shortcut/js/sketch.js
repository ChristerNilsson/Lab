...
var Button, LAT, LNG, RADIUS, Rmeter, a, b, buttons, count, draw, dx, dy, hist, locationUpdate, locationUpdateFail, mousePressed, mouseReleased, position, radius, released, rmeter, setup, start, stopp, track, wgs84ToXY;
...
setup = function setup() {
  var i, j, labels, len, meterPerPixlar, txt, x, y;
