...
var Arc, Circle, Group, Polygon, Rect, Shape, Vector, cn, draw, message, mouseMoved, mousePressed, setup, shapes, stage;
...
setup = function setup() {
  ...
  for (i = k = 0, len = alfabet.length; k < len; i = ++k) {
    ...
    cn.circle(x, y, 40, shapes.letters).fill("#f00").text(letter).clicked(function () {
...
draw = function draw() {
  var child, k, l, len, len1, ref, ref1;
  bg(0.5);
  stage.draw();
