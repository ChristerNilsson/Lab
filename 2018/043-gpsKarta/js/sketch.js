...
var A, B, C, D, DATA, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawPoints, drawTrack, fetchData, gps, gpsLat, gpsLon, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, mousePressed, myMousePressed, myround, points, position, preload, setup, show, soundDown, soundIndicator, soundUp, spara, storeData, track, trgLat, trgLon, vercal, xdraw;
...
myMousePressed = function myMousePressed(mx, my) {
  var arr, button, closestControl, control, d, j, key, len, x, y;
  for (j = 0, len = buttons.length; j < len; j++) {
    button = buttons[j];
  ...
  if (d < 85) {
    ...
    trgLat = _gps$bmp2gps2[0];
    trgLon = _gps$bmp2gps2[1];
