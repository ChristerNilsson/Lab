...
var A, B, C, D, DATA, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawTrack, gps, gpsLat, gpsLon, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, myMousePressed, myround, position, preload, setTarget, setup, show, soundDown, soundIndicator, soundUp, spara, track, trgLat, trgLon, vercal, xdraw;
...
setup = function setup() {
  ...
  buttons.push(new Button('S', x1, y1, function () {
    ...
    return controls['bike'] = position;
  }));
  buttons.push(new Button('U', x, y1, function () {
    return cy -= 0.25 * height / SCALE;
  }));
  buttons.push(new Button('R', x2, y1, function () {
