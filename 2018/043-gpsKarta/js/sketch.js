...
locationUpdate = function locationUpdate(p) {
  ...
  if (lastLatLon.distanceTo(currLatLon) > 5) {
    // meter
...
drawControl = function drawControl() {
  var bearing, control, diff, distance, lat, latLon1, latLon2, lon, x, y;
