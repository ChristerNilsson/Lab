...
var A, B, C, D, DATA, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, bearing, buttons, corner, cx, cy, drawButtons, drawCompass, drawPoints, drawTrack, fetchData, gps, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, mousePressed, myround, points, position, preload, setup, setupCompass, show, spara, storeData, test, track, vercal, xdraw;
...
mousePressed = function mousePressed() {
  // For use on PC during development only.
  var button, j, len, x, y;
  x = cx + mouseX / SCALE - width / 2;
  y = cy + mouseY / SCALE - height / 2;
  print({ mouseX: mouseX, mouseY: mouseY, cx: cx, cy: cy, SCALE: SCALE, x: x, y: y });
