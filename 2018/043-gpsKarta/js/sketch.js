...
var A, B, C, D, DATA, DELAY, DIST, DISTANCES, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawTrack, gps, gpsLat, gpsLon, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, myMousePressed, myround, playSound, position, preload, say, sayBearing, sayDistance, setTarget, setup, show, showSpeed, soundDown, soundIndicator, soundQueue, soundUp, spara, timeout, track, trgLat, trgLon, vercal, xdraw;
...
say = function say(m) {
  var index = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
