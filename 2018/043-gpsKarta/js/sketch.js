...
var A, B, C, D, DATA, DELAY, DIST, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawTrack, gps, gpsLat, gpsLon, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, myMousePressed, myround, playSound, position, preload, setTarget, setup, show, soundDown, soundIndicator, soundQueue, soundUp, spara, timeout, track, trgLat, trgLon, vercal, xdraw;
