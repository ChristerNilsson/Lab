...
var A, B, C, D, DATA, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, bearing, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawPoints, drawTrack, fetchData, gps, gpsLat, gpsLon, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, myMousePressed, myround, points, position, preload, setup, show, spara, storeData, track, vercal, xdraw;
...
drawControl = function drawControl() {
  var control, lat, latLon1, latLon2, lon, x, y;
