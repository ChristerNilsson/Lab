...
var A, B, C, D, DATA, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawPoints, drawTrack, fetchData, gps, gpsLat, gpsLon, heading, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, myMousePressed, myround, points, position, preload, setup, show, spara, storeData, track, vercal, xdraw;
