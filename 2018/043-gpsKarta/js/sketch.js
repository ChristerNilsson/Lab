...
var A, B, C, D, DATA, DELAY, DIST, DISTANCES, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, buttons, controls, corner, currentControl, cx, cy, drawButtons, drawControl, drawTrack, gps, gpsLat, gpsLon, hortal, img, locationUpdate, locationUpdateFail, makeCorners, messages, myMousePressed, myround, playSound, position, preload, say, setTarget, setup, show, soundDown, soundIndicator, soundQueue, soundUp, spara, timeout, track, trgLat, trgLon, vercal, voiceDistance, xdraw;
...
voiceDistance = function voiceDistance(a, b) {
...
soundIndicator = function soundIndicator(p) {
  var a, b, c, dista, distance, distb;
