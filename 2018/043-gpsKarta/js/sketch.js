...
var A, B, C, D, DATA, E, FILENAME, HEIGHT, SCALE, TRACKED, WIDTH, bearing, buttons, corner, cx, cy, draw, drawButtons, drawCompass, drawPoints, drawTrack, fetchData, gps, hortal, img, locationUpdate, locationUpdateFail, makeCorners, mouseReleased, mouseTouched, myround, points, position, preload, released, setup, setupCompass, show, spara, storeData, track, vercal;
...
setup = function setup() {
  ...
  y1 = 100;
  y2 = height - 100;
  buttons.push(new Button('S3', x1, y1, function () {
