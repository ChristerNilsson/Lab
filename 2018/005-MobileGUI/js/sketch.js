...
var BLACK, DATA, DECLINATION, GREEN, LINK, RED, WHITE, bearing, draw, fetchData, h, heading_12, hideCanvas, lastObservation, locationUpdate, locationUpdateFail, logg, p1, pages, place, placeIndex, places, setup, setupCompass, showCanvas, start, startDate, storeData, texts, track, w;
...
storeData = function storeData() {
  ...
  return localStorage[DATA] = JSON.stringify(places);
};
