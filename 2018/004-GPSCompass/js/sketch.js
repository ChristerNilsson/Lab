...
var deltas, deltat, distance, heading, locationUpdate, locationUpdateFail, p1, p2, positionHng, positionLat, positionLng, positionSpd, positionTimestamp, speed, track;
...
locationUpdate = function locationUpdate(position) {
  ...
  if (track.length >= 2) {
    ...
    speed.textContent = "?";
    return heading.textContent = Math.round(calcHeading(p0.lat, p0.lng, p1.lat, p1.lng)) + " grader";
  }
};
