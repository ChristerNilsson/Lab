...
//spd: null # m/s
var bearing, deltas, deltat, distance, heading, locationUpdate, locationUpdateFail, p2, points, positionHng, positionLat, positionLng, positionSpd, positionTimestamp, track;
...
locationUpdate = function locationUpdate(position) {
  ...
  positionHng.textContent = Math.round(calcHeading(p1, p2)) + "\xB0";
...
window.addEventListener("deviceorientation", function (event) {
  ...
  console.log(heading);
  return bearing.textContent = heading;
});
