...
var locationUpdate, locationUpdateFail, positionCurrent, positionHng, positionLat, positionLng, positionSpd, positionTarget, positionTimestamp;
...
locationUpdate = function locationUpdate(position) {
  ...
  return positionTimestamp.textContent = positionCurrent.timestamp;
};
