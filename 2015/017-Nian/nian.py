...
assert find_words('taaekllnr') == ['akne', 'akta', 'akter', 'aktre', 'alka', 'anka', 'ankar', 'ankare', 'ankel', 'ankra', 'elak', 'enkla', 'kall', 'kalla', 'kallna', 'kalna', 'kana', 'kanal', 'kanel', 'kant', 'kanta', 'kantare', 'kantarell', 'kantra', 'kara', 'karat', 'karate', 'karel', 'karet', 'karl', 'kart', 'karta', 'kartell', 'kela', 'klan', 'klant', 'klanta', 'klar', 'klara', 'klarna', 'klen', 'klena', 'klet', 'kleta', 'knal', 'knall', 'knalla', 'knalle', 'knata', 'kraal', 'kral', 'kralla', 'kran', 'krana', 'kreta', 'laka', 'lakan', 'lake', 'lank', 'lanka', 'leka', 'lekt', 'neka', 'nektar', 'raka', 'raken', 'raket', 'rakna', 'rank', 'ranka', 'reka', 'taka', 'talk', 'talka', 'tank', 'tanka', 'tanke', 'tanker', 'teak', 'teka', 'trake']